"""
Django settings for long_disk_dev_58959 project.
...
ROOT_URLCONF = 'long_disk_dev_58959.urls'
...
WSGI_APPLICATION = 'long_disk_dev_58959.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_disk_dev_58959 API",
    "DESCRIPTION": "API documentation for long_disk_dev_58959 App",
    "VERSION": "v1",
}
